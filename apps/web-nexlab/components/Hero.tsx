...
export const Hero = () => {
  return (
    <Box position="relative" bg="white" w="100%" h={{ base: '30rem', sm: '40rem', md: '48rem', lg: '43rem' }} pt="4.5rem" overflow="hidden">
      <Container maxW="container.xl" position="relative" h="100%">
        <Box pt={{ base: '3rem', md: '5rem' }} textAlign={{ base: 'center', lg: 'left' }} zIndex={1}>
          <Text fontFamily="mono" pb={{ base: '1.5rem', md: '0.5rem' }} fontWeight="bold" color="gray.600" fontSize={{ base: '1rem', md: '1.25rem' }}>
            Quieres innovar, pero aún no sabes dónde empezar.
          </Text>
          <Heading fontSize={{ base: '2rem', md: '4rem' }} fontWeight="bold" lineHeight="1.2">
