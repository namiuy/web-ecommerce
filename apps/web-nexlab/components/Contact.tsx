...
export const Contact = () => {
  ...
  return (
    <Container maxW="container.xl" px={4}>
      <Flex justifyContent="space-between" alignItems="center" flexDir={{ base: 'column', lg: 'row' }} gap="2rem" pt="2rem" pb="2rem">
        <Text fontSize={{ base: '2rem', lg: '3rem' }} maxW="30rem" fontWeight="bold" lineHeight="3.25rem" textAlign={{ base: 'center', lg: 'left' }}>
          Cuéntanos cómo podemos ayudarte.
        </Text>
        <Box bg="white" p="2.5rem" borderRadius="1rem" w={{ base: '90%', lg: '50%' }}>
          <Formik
            initialValues={{
              name: '',
              email: '',
          ...
          >
            {({ handleSubmit, errors }) => (
              <form onSubmit={handleSubmit}>
                <Grid
                  gridTemplateAreas={{ base: "'a' 'b' 'c' 'd' 'e'", lg: "'a b' 'c d' 'e e'" }}
                  ...
                  <GridItem w="100%" gridArea="b">
                    <FormControl isInvalid={!!errors.email}>
                      ...
                      <Field
                        ...
                        name="email"
                        type="text"
                        placeholder="pedrogonzalez@ejemplo.com"
                        bg="#f5f5f7"
                        borderColor="#f5f5f7"
                        fontSize="0.875rem"
                        py="1.25rem"
                  ...
                  <GridItem w="100%" gridArea="d">
                    ...
                    <FormControl isInvalid={!!errors.subject}>
                      <Field
                        ...
                        name="subject"
                        type="text"
                        placeholder="Pedro González S.A."
                        bg="#f5f5f7"
                        borderColor="#f5f5f7"
                        fontSize="0.875rem"
                        py="1.25rem"
