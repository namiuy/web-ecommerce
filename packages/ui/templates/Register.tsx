...
import { Link, FormControl, FormLabel, FormErrorMessage, Input, Select } from '@chakra-ui/react';
  ...
  return (
    <Box height={'100vh'} bg={_backgroundColorTwo}>
      <Box bgGradient={_backgroundGradient} h={'40rem'}>
        ...
        <Container maxW={'40rem'} color={'white'} mt={'5rem'} mb={'1rem'} px={0} display={'flex'} alignItems={'center'}>
          <Link mr={'10rem'} borderRadius={'50%'} p={'0.25rem'} _hover={_backButtonHover}>
            {' '}
